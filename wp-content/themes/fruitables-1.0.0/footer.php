            ...
            <div class="row g-4">
                <div class="col-lg-3">
                    <a href="<?php echo site_url('/'); ?>">
                        <h1 class="text-primary mb-0">Bin Dino Shop</h1>
                        <p class="text-secondary mb-0">Tam Thánh</p>
                    </a>
                </div>
                <div class="col-lg-6">
        ...
        <div class="row g-5">
            <div class="col-lg-3 col-md-6">
                <div class="footer-item">
                    ...
                    <p class="mb-4">siuuuuuuuuuuuuu</p>
                    <a href="" class="btn border-secondary py-2 px-4 rounded-pill text-primary">Đọc ngay</a>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer-item">
                    ...
                    <p>Địa chỉ: 53 Võ Văn Ngân , Linh Chiểu , TP Thủ Đức ,TP Hồ Chí Minh</p>
                    <p>Email: Bindinoshop@gmail.com</p>
                    <p>Số điện thoại: +0388 888 888</p>
                    <p>Thanh toán</p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                <span class="text-light"><a href="<?php echo site_url('/'); ?>"><i class="fas fa-copyright text-light me-2"></i>Bin Dino Shop</a>, All right reserved.</span>
            </div>
